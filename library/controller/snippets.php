...
class snippets extends \q_ui {
    ...
    */
    public static function load( $slug = null, $args = array() )
    {
        ...
        \Q_Control::get_snippet( $slug, $args );
    ...
    */
    public static function blockquote( $args = array() )
    {
        ...
        // get the_post ##
        if ( ! $the_post = \Q_Control::the_post( $args ) ) { return false; }
...
<?php
    ...
    public static function contact_link( $title = null )
    {
        ...
        if ( ! $post = \Q_Control::get_post_by_meta( array( 'meta_value' => 'contact' ) ) ) { return false; }
...
<?php
            ...
            // privacy link ##
            \Q_Control::the_snippet( 'privacy_link' );
...
<?php
    ...
    public static function privacy_link()
    {
        ...
        // check we got a result ##
        if ( ! $post = \Q_Control::get_post_by_meta( array( 'meta_value' => 'privacy' ) ) ) { return false; }
...
<?php
    ...
    public static function parent( $args = array() )
    {
        ...
        if ( ! $object = \Q_Control::get_parent( $args ) ) { return false; }
