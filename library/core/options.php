...
// load it up ##
\q\ui\core\options::run();

class options extends \q_ui {
    ...
    */
    ...
    public static function options_page() 
    {
        ...
        // get Q options ##
        $options = \q_array_to_object( self::get() );
...
<?php
        ...
        echo "<h2>".__( 'Q Theme Options', 'q-textdomain' ).$version."</h2>"; 
